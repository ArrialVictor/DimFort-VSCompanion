...
| `DimFort: Status` | Append a timestamped snapshot of the current DimFort settings + LSP client state to the `DimFort Status` Output channel, then reveal that channel (`dimfort.status`). |
