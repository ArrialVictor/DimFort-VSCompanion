...
no-unit) now render with the muted theme colour in the panel's
Scope and Imports tables, so real units pop visually. The
expression-tree dimming is deferred to a later pass.
